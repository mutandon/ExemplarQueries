 ...
 */
public class LoadException extends ExecutionException {

    public LoadException(Throwable cause) {
        super(cause);
    }

    public LoadException(String formatString, Throwable cause, Object... parameters) {
        super(formatString, cause, parameters);
    }

    public LoadException(String message, Object... parameters) {
